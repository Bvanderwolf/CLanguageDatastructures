...
extern MunitSuite llist_add_back_suite;
extern MunitSuite llist_insert_suite;
...
int main(int argc, char* argv[MUNIT_ARRAY_PARAM(argc + 1)]) 
{
	MunitSuite suites[] = { 
		...
		llist_find_suite, llist_add_front_suite, llist_add_back_suite, 
		llist_insert_suite, llist_suite_terminator 
	};
